...
public class EANSearchOrgPlugin implements EANTitlePlugin {

	private static final String IMAGE_URL = "http://www.ean-search.org/perl/ean-search.pl?q=";
	...
	public String getEANTitle() throws IOException {
		...
		Elements elementsAHref = html.getElementsByAttributeValueStarting("href", "/perl/ean-info.pl?ean=");
		for (Element element : elementsAHref) {
			return element.text();
		}
